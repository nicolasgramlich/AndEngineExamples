...
public class AnimationBenchmark extends BaseBenchmark {
	...
	public Engine onLoadEngine() {
		...
		final EngineOptions engineOptions = new EngineOptions(true, ScreenOrientation.LANDSCAPE, new RatioResolutionPolicy(CAMERA_WIDTH, CAMERA_HEIGHT), this.mCamera, false);
	...
	public Scene onLoadScene() {
		...
		faceSharedVertexBuffer.onUpdate(0, 0, this.mFaceTextureRegion.getTileWidth(), this.mFaceTextureRegion.getTileHeight());

		final RectangleVertexBuffer helicopterSharedVertexBuffer = new RectangleVertexBuffer(GL11.GL_DYNAMIC_DRAW);
		helicopterSharedVertexBuffer.onUpdate(0, 0, this.mHelicopterTextureRegion.getTileWidth(), this.mHelicopterTextureRegion.getTileHeight());

		final RectangleVertexBuffer snapdragonSharedVertexBuffer = new RectangleVertexBuffer(GL11.GL_DYNAMIC_DRAW);
		snapdragonSharedVertexBuffer.onUpdate(0, 0, this.mSnapdragonTextureRegion.getTileWidth(), this.mSnapdragonTextureRegion.getTileHeight());

		final RectangleVertexBuffer bananaSharedVertexBuffer = new RectangleVertexBuffer(GL11.GL_DYNAMIC_DRAW);
		bananaSharedVertexBuffer.onUpdate(0, 0, this.mBananaTextureRegion.getTileWidth(), this.mBananaTextureRegion.getTileHeight());
