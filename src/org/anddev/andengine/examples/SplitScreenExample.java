 ...
 */
public class SplitScreenExample extends BaseExampleGameActivity implements IAccelerometerListener, IOnSceneTouchListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public Engine onLoadEngine() {
		final Camera firstCamera = new Camera(0, 0, CAMERA_WIDTH / 2, CAMERA_HEIGHT);
		final ChaseCamera secondCamera = new ChaseCamera(0, CAMERA_HEIGHT + 1, CAMERA_WIDTH / 2, -CAMERA_HEIGHT, null);
