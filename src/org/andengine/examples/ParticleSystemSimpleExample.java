...
public class ParticleSystemSimpleExample extends BaseExample {
	...
	protected Scene onCreateScene() {
		...
		particleSystem.addParticleModifier(new ScaleParticleModifier<Sprite>(1.0f, 2.0f, 0, 5));
		particleSystem.addParticleModifier(new ColorParticleModifier<Sprite>(1, 1, 0, 0.5f, 0, 0, 0, 3));
		particleSystem.addParticleModifier(new ColorParticleModifier<Sprite>(1, 1, 0.5f, 1, 0, 1, 4, 6));
		particleSystem.addParticleModifier(new AlphaParticleModifier<Sprite>(0, 1, 0, 1));
		particleSystem.addParticleModifier(new AlphaParticleModifier<Sprite>(1, 0, 5, 6));
		particleSystem.addParticleModifier(new ExpireParticleModifier<Sprite>(6, 6));
